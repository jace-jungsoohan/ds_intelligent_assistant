...
const SUGGESTIONS = [
    "📉 2025년 12월 상하이(CNSHG)행 총 물량 및 파손율",
    "🔥 운송구간(location_fin_corrected) 별 충격 리스크 히트맵",
    "⚠️ 11~12월 누적 충격 피로도 Top 5 운송 건",
    "🍬 오사카행 온도 이탈 평균 지속 시간 (10-12월)",
    "📊 포장 타입별 파손율 및 안전 점수 비교",
    "🛳️ 해상 운송 중 5G 이상 충격 발생 비율",
    "📍 베트남 경로 습도 취약 구간 분석",
    "❄️ 12월 영하 온도에서 발생한 충격 건수",
    "🏆 4분기 운송사별 배송 품질 벤치마킹",
    "🚨 최근 도착한 High Risk 등급 운송 건 조회",
    "📦 포장재별 평균 온도 유지 성능",
    "✈️ 항공 운송 중 과도한 기울기(Tilt) 발생 건수",
    "📅 2025년 4분기 월별 무사고(파손 0) 비율 추이",
    "🚛 트럭 운송 시 평균 충격량(G) 통계",
    "🔄 12월 운송경로 별 도착지 물동량 흐름 (Sankey)"
];
